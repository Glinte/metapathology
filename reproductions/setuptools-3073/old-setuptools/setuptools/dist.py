...
def check_importable(dist, attr, value):
    try:
        ...
        raise DistutilsSetupError("%r must be importable 'module:attrs' string (got %r)" % (attr, value))
...
class Feature:
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    def __init__(
        self, description, standard=False, available=True, optional=True, require_features=(), remove=(), **extras
    ):
