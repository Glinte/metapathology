...
def test_install_toggle_and_uninstall_preserve_live_path_hooks(run_python: RunPython) -> None:
    proc = run_python(
        "import sys\n"
...
def test_path_hook_mutators_record_plain_identity_data_without_calling_hooks(run_python: RunPython) -> None:
    proc = run_python(
        "import sys\n"
        "import metapathology\n"
...
def test_path_hooks_reassignment_is_recovered_on_next_import(run_python: RunPython) -> None:
    proc = run_python(
        "import sys\n"
        "import metapathology\n"
...
def test_simultaneous_import_list_reassignments_use_meta_then_path_hook_sequence(run_python: RunPython) -> None:
    proc = run_python(
        "import sys\n"
        "import metapathology\n"
...
def test_hostile_callable_metadata_is_not_inspected(run_python: RunPython) -> None:
    proc = run_python(
        "import sys\n"
        "import metapathology\n"
        "from metapathology import PathHooksMutation\n"
...
def test_path_hook_callback_is_inert_during_reentrant_finder_instrumentation(run_python: RunPython) -> None:
    proc = run_python(
        "import sys\n"
        "import metapathology\n"
        "from metapathology import PathHooksMutation\n"
...
def test_concurrent_path_hook_mutation_reads_reports_and_cleanup_are_safe(run_python: RunPython) -> None:
    proc = run_python(
        "import sys\n"
        "import threading\n"
        "import metapathology\n"
