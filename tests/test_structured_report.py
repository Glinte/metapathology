...
assert document["schema"] == {"major": 0, "minor": 14, "name": "metapathology.report"}
...
def test_report_document_uses_hand_written_slots(run_python: RunPython) -> None:
    proc = run_python(
        ...
        "    modules_since_install=(), events=(), skipped_finders=(), standard_resolutions=(),\n"
        "    standard_finder_status='disabled', findings=(),\n"
